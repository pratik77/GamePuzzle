...
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://pratik77root:rootpass@db4free.net:3306/puzzlegamedb'
#app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql+psycopg2://postgres:admin@localhost:5432/puzzle_game'
